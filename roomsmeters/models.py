...
class Rentaroom(models.Model):
    ...
    watermeter = models.OneToOneField(
        Watermeter,
        on_delete=models.CASCADE,
    ...
    electricitymeter = models.OneToOneField(
        Electricitymeter,
        on_delete=models.CASCADE,
    ...
    spotelectr = models.ForeignKey(Spotelectr, default="", verbose_name="Название участка для Электроэнергии",
                                   on_delete=models.CASCADE)
    spotwater = models.ForeignKey(Spotwater, default="", verbose_name="Название участка для воды",
                                  on_delete=models.CASCADE)
    lessor = models.ForeignKey(Lessor, default="", verbose_name="Арендодатель",
                                   on_delete=models.CASCADE)


    isfree = models.BooleanField(default=True, verbose_name="Помещеине свободно?")
